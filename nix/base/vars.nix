...
in {
  ...
  in rec {
    ...
    prsw_sh = ["prsw_sh" 1001 (["audio" "video" "sh_x" "stash" "pulse"] ++ (u2g.prsw or [])) (keys.sh_prsw or []) {home="/home/prsw/sh";}];
    prsw_sophia = ["prsw_sophia" 1001 (["audio" "video" "sh_x" "stash" "pulse"] ++ (u2g.prsw or [])) (sophia_keys) {home="/home/prsw/sophia";}];
    prsw_net_sh = ["prsw_net_sh" 1005 ["audio" "video" "sh_x" "stash" "pulse"] (keys.sh_prsw or []) {home="/home/prsw_net/sh";}];
